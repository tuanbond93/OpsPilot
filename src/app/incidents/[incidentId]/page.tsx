...
export default function IncidentDetailPage() {
  ...
  useEffect(() => {
    if (!operationalRollup?.analyzedCount || window.location.hash !== "#operational-review") return;
    window.requestAnimationFrame(() => {
      const target = document.getElementById("operational-review");
