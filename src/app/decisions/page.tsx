...
type TelegramDispatch = { id: string; status: "PENDING" | "SENT" | "FAILED"; telegram_message_id: number | null; recipient_member_ids: string[]; sent_at: string | null; failure_reason: string | null; feedbacks?: Array<{ id: string; feedback_text: string; received_at: string; telegram_pilot_members?: { display_name?: string; username?: string | null } | null }> };
